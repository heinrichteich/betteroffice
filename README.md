...
Visio drawings (`.vsdx`) and templates (`.vstx`) open in the source-available VSDX core, which is not yet published. Diagrams export headlessly to PowerPoint (one slide per page of native shapes) and Word (shapes plus a shape-data table). Stencils (`.vssx`) and macro-enabled files are not supported.
...
| --- | --- | ---: | ---: | --- | ---: | ---: |
| DOCX | [0.1.0](https://www.npmjs.com/package/@betteroffice/docx/v/0.1.0) | 0.7538 | 14/14 | [a35d4baa](https://github.com/openooxml/betteroffice/commit/a35d4baa1f5415f557d7dc9bae179f159afd5591) | 0.8309 | 14/14 |
