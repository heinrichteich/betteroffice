...
### Diagrams — `.vsdx` (source preview, not yet published)

The VSDX diagram editor scrolls and pans around a work surface with the page centred in it: space- or middle-drag panning, and ctrl+wheel zoom anchored under the pointer.
