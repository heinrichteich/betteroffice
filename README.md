...
VSDX support is available from source and is not yet published. The headless Rust exporter creates editable PowerPoint slides and Word diagrams, with shape-data tables and export reports.
