...
export interface PageDisplayList { contractVersion: 5; width: number; height: number; printWidth: number; printHeight: number; paintTransform: Affine; primitives: PagePrimitive[]; }
