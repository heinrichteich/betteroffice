...
export interface ShapeSnapshot { id: string; sourceId: number; name: string | null; cells: CellSnapshot[]; children: ShapeSnapshot[]; copySourceId?: number | null; copySourcePageId?: number | null; copyRefusal?: string | null; }
...
export interface PageDisplayList { contractVersion: 6; width: number; height: number; printWidth: number; printHeight: number; paintTransform: Affine; primitives: PagePrimitive[]; connectors?: ConnectorChrome[]; }
