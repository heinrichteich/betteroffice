...
export type RibbonIconName = 'undo' | 'redo' | 'delete' | 'add' | 'download' | 'fill' | 'line' | 'weight' | 'pattern' | 'front' | 'forward' | 'backward' | 'back' | 'rotateLeft' | 'rotateRight' | 'flipHorizontal' | 'flipVertical' | 'pageBreaks' | 'connector' | 'grid' | 'snap' | 'ruler';
