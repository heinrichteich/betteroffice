...
export type RibbonIconName = 'undo' | 'redo' | 'delete' | 'cut' | 'copy' | 'paste' | 'duplicate' | 'add' | 'download' | 'fill' | 'line' | 'weight' | 'pattern' | 'front' | 'forward' | 'backward' | 'back' | 'rotateLeft' | 'rotateRight' | 'flipHorizontal' | 'flipVertical';
