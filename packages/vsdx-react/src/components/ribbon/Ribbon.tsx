...
export function Ribbon({ t, hasSelection = false, view = { grid: true, snap: true, rulers: true }, onToggleView = () => {} }: { t: TFunction; hasSelection?: boolean; view?: RibbonViewState; onToggleView?: (key: ViewToggleKey) => void }) {
