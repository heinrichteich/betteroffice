...
export const PACKAGES = [
  ...
  },
  {
    ...
    sourceOnly: true,
    desc: "The VSDX editor as a drop-in React component: a tabbed ribbon, a searchable standard-shape gallery, a page tab strip and a zoom status bar over move, marquee selection, resize with handles and Shift-drag, add, delete, set fill or line colour, and save, with keyboard undo and redo, Delete, arrow-key nudge with a larger Shift step, Ctrl+A to select every shape on the page, and Escape to clear the selection or cancel a drag, working anywhere in the editor except text fields and open menus, plus a right-click context menu for delete and z-order arrange, with the arrange commands in submenus. No connector-drag UI.",
  },
];
