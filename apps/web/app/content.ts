...
export const EDITORS = [
  ...
  },
  {
    name: "Diagrams",
    format: "vsdx",
    desc: "VSDX editor with a tabbed ribbon, a standard-shape gallery, a page tab strip and a zoom status bar, for moving, Shift-drag resizing, adding and deleting shapes, cutting, copying and pasting shapes including groups, setting fill and line colour, and saving diagrams. No resize-handle or connector-drag UI.",
...
export const PACKAGES = [
  ...
  },
  {
    ...
    sourceOnly: true,
    desc: "The VSDX editor as a drop-in React component: a tabbed ribbon, a searchable standard-shape gallery, a page tab strip and a zoom status bar over move, resize with Shift-drag, add, delete, cut, copy and paste including groups, set fill or line colour, and save. No resize-handle or connector-drag UI.",
  },
];
