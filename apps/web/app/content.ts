...
export const PACKAGES = [
  ...
  },
  {
    ...
    sourceOnly: true,
    desc: "The VSDX editor as a drop-in React component: a tabbed ribbon, a searchable standard-shape gallery, a page tab strip and a zoom status bar over move, resize with handles and Shift-drag, add, delete, set fill or line colour, and save. No connector-drag UI.",
  },
];
