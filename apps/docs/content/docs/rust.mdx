...
| `betteroffice-vsdx` | Typed native API for inspecting VSDX diagrams. |
...
| `betteroffice-vsdx-parse` | Bounded Visio XML parsing and part-preserving VSDX package serialization. |
| `betteroffice-vsdx-resolve` | Resolved Visio ShapeSheet inheritance, text, and geometry. |
| `betteroffice-vsdx-eval` | The bounded baseline ShapeSheet formula evaluator behind VSDX display. |
| `betteroffice-vsdx-render` | The VSDX display-list compiler and hit testing. |
| `betteroffice-vsdx-edit` | The Yrs diagram model for VSDX. |
