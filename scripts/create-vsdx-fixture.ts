...
async function writeTestFixtures(): Promise<void> {
  ...
  await writeZip(path.join(root, 'crates/vsdx-parse/tests/fixtures/data-binding.vsdx'), {
    ...parts,
    'visio/pages/page1.xml': `<PageContents ${ns}><Shapes><Shape ID='1' Type='Shape'>${xform(2, 1, 2, 2, 1, 0.5, 0, 0, 0)}${rect}<Section N='Property'><Row N='Device'><Cell N='Label' V='Device'/><Cell N='Value' F='"Amp"' V='Amp'/><Cell N='Type' V='0'/></Row><Row N='Owner'><Cell N='Label' V='Owner'/><Cell N='Value' F='"Ada"' V='Ada'/><Cell N='Type' V='0'/></Row><Row N='Count'><Cell N='Label' V='Count'/><Cell N='Value' V='4'/><Cell N='Type' V='2'/></Row><Row N='Due'><Cell N='Label' V='Due date'/><Cell N='Value' F='DATETIME(45000)' V='3 March'/><Cell N='Type' V='5'/></Row></Section></Shape></Shapes></PageContents>`,
  });
