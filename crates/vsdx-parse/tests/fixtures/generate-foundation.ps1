...
$parts = [ordered]@{
    ...
    'visio/pages/page1.xml' = "<PageContents xmlns='http://schemas.microsoft.com/office/visio/2012/main'><Shapes><Shape ID='1' NameU='Process' Type='Shape'><Cell N='PinX' V='4'/><Cell N='PinY' V='5'/><Cell N='Width' V='2'/><Cell N='Height' V='1'/><Cell N='Del' V='1'/><Section N='Geometry'><Row T='RelMoveTo'><Cell N='X' V='0'/><Cell N='Y' V='0'/></Row><Row T='RelLineTo' N='LineTo'><Cell N='X' V='1'/><Cell N='Y' V='1'/></Row></Section><Section N='Connection'><Row T='Connection'><Cell N='X' V='0.5'/><Cell N='Y' V='0.5'/></Row></Section><Text>Step <fld IX='0'/></Text></Shape></Shapes><Connects><Connect FromSheet='1' FromCell='BeginX' FromPart='9' ToSheet='1' ToCell='PinX' ToPart='3'/></Connects></PageContents>"
